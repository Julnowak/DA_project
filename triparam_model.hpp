...
namespace triparam_model_model_namespace {
...
class triparam_model_model final : public model_base_crtp<triparam_model_model> {
 ...
 public:
  ~triparam_model_model() { }
  
  inline std::string model_name() const final { return "triparam_model_model"; }
  ...
  triparam_model_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "triparam_model_model_namespace::triparam_model_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "triparam_model_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "triparam_model_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
...
using stan_model = triparam_model_model_namespace::triparam_model_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return triparam_model_model_namespace::profiles__;
}
